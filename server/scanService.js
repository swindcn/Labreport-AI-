...
export function inferMockScanScenario(fileName) {
...
export function createMockUploadedReport(input) {
...
export function completeMockScanReport(report) {
...
export function retryMockScanReport(report) {
  return {
    ...report,
    status: "processing",
